...
class JobsdbPipeline(object):
    ...
    def _conditional_insert(self,tx,item):
        tx.execute('INSERT INTO positiondetail (PostDate, PositionID, \
            Position, JobLvl, MinCareerLvl, WorkExperience, Benefits, Industry, Function, \
            Location, Salary, Links, Company, Content) VALUES (%s, %s, %s, %s, %s, \
            %s, %s, %s, %s, %s, %s, %s, %s, %s)',
            (item['PostDate'],item['PositionID'],item['Position'],
             item['JobLvl'], item['MinCareerLvl'], item['WorkExperience'],\
